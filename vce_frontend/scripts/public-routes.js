...
function homeContent() {
  return `
    <main class="prerender-shell">
      <h1>VCE Science Resources</h1>
      <p>Study VCE Physics, Chemistry and Biology Units 3 and 4 with topic summaries, practice questions, worked solutions and practice SACs.</p>
...
function subjectContent(metadata) {
  ...
  if (section === 'practice-sac') {
    return `
      <main class="prerender-shell">
        <h1>VCE ${subjectName} Units 3/4 Practice SACs</h1>
  ...
  return `
    <main class="prerender-shell">
      <h1>VCE ${subjectName} Units 3/4 ${sectionName}</h1>
